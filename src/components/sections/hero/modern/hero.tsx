...
function Hero() {
  ...
  return (
    <section
      ...
      ref={container}
    >
      <div className="relative z-10 h-[32.5dvh] md:h-[41.2dvh] md:min-h-[40dvh] xl:h-[51.2dvh]">
        <div className="relative flex h-full flex-col items-center justify-center">
          <div className="flex w-full items-center justify-center px-4 md:px-6">
            <h1 className="text-3xl font-light sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
              <span>A </span>
              <TextLoop
